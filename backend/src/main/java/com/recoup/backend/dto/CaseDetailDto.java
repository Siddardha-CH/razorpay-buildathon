...
public record CaseDetailDto(
    ...
    String intervention, String decisionReasoning, long estimatedCostPaise, double estimatedRecoveryProbability,
    ...
    public static CaseDetailDto from(RecoveryCase c, List<AuditEntryDto> auditTrail) {
        return new CaseDetailDto(
            ...
            c.getDecision().getIntervention().name(), c.getDecision().getReasoning(), c.getDecision().getEstimatedCostPaise(), c.getDecision().getEstimatedRecoveryProbability(),
